      ...
      <section className="relative min-h-[90vh] flex items-center justify-center px-6 pt-24">
        <div className="w-full max-w-6xl flex flex-col items-center gap-10">
          ...
          <div className="flex flex-col items-center gap-6 text-center">
            <h1 className="text-lg md:text-2xl lg:text-3xl font-bold tracking-tighter text-zinc-900 dark:text-zinc-100">
              Privacy-First Anonymous Messaging Platform
            </h1>

            <h2 className="text-4xl md:text-5xl lg:text-6xl font-semibold tracking-tight text-zinc-900 dark:text-zinc-100">
              Say Anything.
